...
import com.ifhu.meiwei.adapter.SearchResultAdapter;
...
public class ChooseAddressPointActivity extends BaseActivity implements LocationSource,
    ...
    private void initView() {
        ...
        searchResultAdapter = new SearchResultAdapter(ChooseAddressPointActivity.this);
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (newText.length() > 0) {
                    ...
                    Inputtips inputTips = new Inputtips(ChooseAddressPointActivity.this, inputquery);
...
//        Log.i("MY", "doSearchQuery");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(ChooseAddressPointActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (poiResult != null && poiResult.getQuery() != null) {
                if (poiResult.getQuery().equals(query)) {
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(ChooseAddressPointActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(ChooseAddressPointActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(ChooseAddressPointActivity.this, "erroCode " + rCode, Toast.LENGTH_SHORT).show();
            }
        }
    };
